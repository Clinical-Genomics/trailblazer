...
def test_filter_analyses_by_hold_delivery(store: Store, hold_delivery: bool):
    ...
    # THEN the returned analyses should only contain the expected analysis
    assert analyses.one().hold_delivery == hold_delivery


def test_filter_analyses_by_hold_delivery_equals_none(store: Store):
