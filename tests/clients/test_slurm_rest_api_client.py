...
from trailblazer.clients.slurm_api_client.slurm_api_client import SlurmRestApiClient


def test_get_slurm_jobs(client: SlurmRestApiClient, mock_request: Mocker, jobs_response: dict):
