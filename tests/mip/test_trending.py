...
def test_parse_mip_analysis(files_raw) -> dict:
    ...
    trend_test_sample_data = {
        "at_dropout": {"mother": 1.716704},
        "analysis_sex": {"mother": "female"},
        "duplicates": {"mother": 3.7952329122913104},
        "insert_size_standard_deviation": {"mother": 94.353778},
        "mapped_reads": {"mother": 99.74176575073072},
        "median_insert_size": {"mother": 409},
        "gc_dropout": {"mother": 0.214813},
    }
